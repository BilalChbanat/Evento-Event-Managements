                                ...
                                <form action="{{ url('dashboard/events/' . $event->id . '/edit') }}" method="post"
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                        <input type="text" placeholder="Event title" class="border p-2 rounded w-full"
                                            name="title" required value="{{ $event->title }}">
                                        @error('title')
                                    ...
                                    <div class="mb-4 w-full">
                                        <input type="text" placeholder="Event location" class="border p-2 rounded w-full"
                                            name="location" required value="{{ $event->location }}">
                                        @error('location')
                                            <span class="text-red-700">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-4 w-full">
                                        <input type="date" class="border p-2 rounded w-full" name="date" required
                                            value="{{ $event->date }}">
                                        @error('date')
                                            <span class="text-red-700">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <button type="submit" name="addEvent" id="theme-toggle"
