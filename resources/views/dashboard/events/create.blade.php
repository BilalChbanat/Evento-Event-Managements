                        ...
                        <div class="bg-white shadow rounded-lg p-6">
                            ...
                            <form action="" method="post"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <input type="text" placeholder="Event title" class="border p-2 rounded w-full"
                                        name="title" required value="{{old('title')}}">
                                </div>
                                <div class="mb-4 w-full">
                                    <input type="text" placeholder="Event location" class="border p-2 rounded w-full"
                                        name="location" required value="{{old('location')}}">
                                </div>
                                <div class="mb-4 w-full">
                                    <input type="number" min="1" placeholder="Event capacity" class="border p-2 rounded w-full"
                                        name="capacity" required value="{{old('capacity')}}">
                                </div>
                                <div class="mb-4 w-full">
                                    <input type="number" min="1" placeholder="Event price" class="border p-2 rounded w-full"
                                        name="price" required value="{{old('price')}}">
                                </div>
                                <div class="mb-4 w-full">
                                    <input type="date" class="border p-2 rounded w-full"
                                        name="price" required value="{{old('date')}}">
                                </div>
                                <div class="mb-4">
                                    <input type="email" placeholder="Email address"
                                        class="border p-2 rounded w-full cursor-not-allowed" name="email" value="{{$user->email}}" disabled>
                                </div>
                                <div class="mb-4">
